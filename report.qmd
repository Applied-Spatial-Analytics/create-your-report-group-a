...
After running the MSPA analysis (@sec-Methods-Ecological Connectivity Analysis-Morphological Spatial Pattern Analysis)on the Rotterdam envelope area and analysing the distribution of classes, the green network (Core, Islet, Perforation, Edge, Loop, Bridge, Branch) covers 45.77%  of it, while background (the non-green matrix: Background, Core-Opening, Border-Opening) 54.23%.  
...
|---------|------|---------|---------|----------|---------------------------------------------|
| 0       | 1932 | 0.0078  | 0.77    | 0.036    | Moderate connectivity, some patches |
| 1       | 60   | 0.5767  | 1.17    | 0.264    | Very high BC, quality patches |
| 2       | 2730 | 0.0003  | 0.00    | 0.000    | No connectivity, no patches  |
...
distributed across LCZ class 6 (open low-rise) and LCZ class 8 (large low-rise) urban areas.
...
| Cluster | n    | BC mean | Patches | Capacity | Interpretation                              |
|---------|------|---------|---------|----------|---------------------------------------------|
| 0       | 459  | 0.3446  | 3.77    | 0.010    | Fragmented green: many small patches, high BC |
| 1       | 1947 | 0.0012  | 0.39    | 0.005    | Sparse patches, minimal BC |
...
| 4       | 1638 | 0.4292  | 0.82    | 0.016    | High BC major corridors  |
...
quality patches dominated by LCZ class A (dense trees). Cluster 0 represnts fragmented green within the urban fabric, dominated by LCZ class  6 (open low-rise) and LCZ class 8 (large low-rise), comparable to Rotterdam's Cluster 4.

##### Spatial Distribution

![Guangzhou cluster distribution map](images/gz_clusters_all){width=100%}
