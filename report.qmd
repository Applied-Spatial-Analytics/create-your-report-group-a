...
!!! Mention the process of reclassifying (5 equal classes), then adding together through Raster Calculator.
...
Explanation of why we chose these 4 layers, then in depth explanation of each layer (maybe not necesarry cs already mentioned at the top?)
