...
In the Results (@sec-results), the outcome of this analysis for Rotterdam and Guangzhou is presented, which will be used as one of the inputs for the clustering analysis in the next section.
...
### Study Area Selection - to be changed!!!!
...
- 0.2 to 0.5: Sparse or stressed vegetation, grasslands, or senescing crops.
...
#### Road Density
parameters:
search radius: Radius of the circular neighbourhood (in meters).
pixel size:Pixel size of the output raster layer in layer units(in meters).
...
##### Cluster Profiles - will edit it soon 
...
connectivity profiles and urban context. - also will change it since our approach is a bit diff now 
...
####Rotterdam
![Figure X: Zoom in locations of Rotterdam.](
images/Rotterdam_zoomin_intro){width=100%}
